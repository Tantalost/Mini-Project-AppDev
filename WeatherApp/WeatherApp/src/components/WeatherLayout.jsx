    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-sky-300 to-emerald-200 text-slate-900 flex flex-col">
            <header className="relative p-6 pt-7">
                ...
                <button
                    className="absolute right-5 top-7 size-10 rounded-full bg-white shadow-lg"
                    aria-label="Profile"
                >
                    <span className="block size-3 rounded-full bg-sky-500 m-auto mt-[14px]" />
                </button>
            </header>
            ...
            <main className="px-4 pb-28 grid gap-4 md:grid-cols-[1.2fr_.8fr] md:gap-6 md:px-6">
                ...
                <section className="rounded-2xl bg-white/50 backdrop-blur p-4 md:sticky md:top-5">
                    ...
                    {locations.map((c) => (
                        <article
                            key={c.name}
                            className="rounded-xl bg-white shadow-lg p-4 mb-3 last:mb-0"
                        >
            ...
            <nav className="fixed left-3 right-3 bottom-3 grid grid-cols-4 gap-2 rounded-[28px] bg-white/90 shadow-2xl p-2">
                <button className="h-12 rounded-full bg-sky-100" aria-label="Home">
                    <FontAwesomeIcon icon={faHouse} className="text-sky-800 text-xl" />
                </button>
                <button className="h-12 rounded-full hover:text-gray-600 hover:bg-sky-200" aria-label="Map">
                    <FontAwesomeIcon icon={faLocationDot} className="text-sky-800 text-xl"/>
                </button>
                <button className="h-12 rounded-full hover:text-gray-600 hover:bg-sky-200" aria-label="Alerts">
                    <FontAwesomeIcon icon={faBell} className='text-sky-800 text-xl'/>
                </button>
                <button className="h-12 rounded-full hover:text-gray-600 hover:bg-sky-200" aria-label="Menu">
                    <FontAwesomeIcon icon={faUser} className='text-sky-800 text-xl' />
                </button>
            </nav>
        </div>
    );
